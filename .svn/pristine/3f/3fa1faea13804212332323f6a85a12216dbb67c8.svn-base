...
@Component({
  ...
  templateUrl: "/src/custom/components/dashboard/groups/groups-widget-settings.component.html",
  directives: []
})

export class GroupsWidgetSettingsComponent extends WidgetSettingsComponent {
