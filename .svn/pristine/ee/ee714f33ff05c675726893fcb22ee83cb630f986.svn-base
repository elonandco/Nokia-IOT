...
@Component({
  ...
  templateUrl: "/src/custom/components/dashboard/firmware/firmware-widget-settings.component.html",
  directives: [ToggleButtonComponent]
})

export class FirmwareWidgetSettingsComponent extends WidgetSettingsComponent {
