...
export class FirmwareWidgetContentComponent extends WidgetContentComponent {
  ...
  getDataBaseOnPreferences(){
      ...
      this.resultStatus = this._firmwareService.resultStatus;
      this.resultMessage = this._firmwareService.resultMessage;
      this.resultCode = this._firmwareService.resultCode;
  }
