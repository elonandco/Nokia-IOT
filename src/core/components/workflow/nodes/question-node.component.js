System.register(["@angular/core", "./abstract-node"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            QuestionNodeComponent = (function (_super) {
                __extends(QuestionNodeComponent, _super);
                function QuestionNodeComponent() {
                    _super.apply(this, arguments);
                }
                QuestionNodeComponent = __decorate([
                    core_1.Component({
                        selector: 'workflow-question-node',
                        templateUrl: '/src/core/components/workflow/nodes/question-node.component.html'
                    }), 
                    __metadata('design:paramtypes', [])
                ], QuestionNodeComponent);
                return QuestionNodeComponent;
            }(abstract_node_1.AbstractNode));
            exports_1("QuestionNodeComponent", QuestionNodeComponent);
        }
    }
});
